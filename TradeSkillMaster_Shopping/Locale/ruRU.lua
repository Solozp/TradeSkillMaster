...
L["Below Max Price"] = "Нииже макс. цены"
-- L["Below Vendor Sell Price"] = ""
L["Bid Percent"] = "Процент ставки"
L["Buyout"] = "Выкуп"
L["Click to search for an item.\nShift-Click to post at market value."] = "Нажмите для поиска предмета.\nShift + клик выставить по рыночной стоимости." 
L["Custom Filter"] = "Поиск по Фильтру"
-- L["Default Post Undercut Amount"] = ""
L["Destroy Mode"] = "Разрушение"
-- L["% DE Value"] = ""
L["Disenchant Search Profit: %s"] = "Поиск выгодных Распылений: %s"
...
L["Exact"] = "Строгий"
L["Favorite Searches"] = "Избранное" -- Needs review
...
L["Hide Grouped Items"] = "Скрывать сгруппированные предметы"
...
L["If set, only items which are usable by your character will be included in the results."] = "Если включено, то в результаты поиска будут включены только те предметы, которые могут быть использованы вашим персонажем."
L["If set, only items which exactly match the search filter you have set will be included in the results."] = "Если включено, то в результаты будут включены только те предметы, назвение которых точно соответствует установленному вами фильтру поиска"
L["Import"] = "Импорт"
L["Import Favorite Search"] = "Добавить в избранне"
...
L["Item Level Range:"] = "Диапазон ilvl"
...
L["Left-Click to run this search."] = "Left-Click для запуска поиска"
L["Log"] = "Журнал"
...
L["Recent Searches"] = "История поиска" -- Needs review
-- L["Relationships"] = ""
-- L["Removed '%s' from your favorite searches."] = ""
-- L["Removed '%s' from your recent searches."] = ""
L["Required Level Range:"] = "Требуемый уровень"
L["Reset Filters"] = "Сброс фильтров"
L["Right-Click to favorite this recent search."] = "Right-Click для добавления в Избранное"
L["Right-Click to remove from favorite searches."] = "Right-Click для удаления из Избранного"
L["Saved Searches"] = "История поиска"
L["Scanning %d / %d (Page %d / %d)"] = "Сканирование %d / %d (Страница %d / %d)"
L["Scanning last page..."] = "Сканирование последней страницы..."
L["Search Filter:"] = "Фильтр поиска"
L["Select the groups which you would like to include in the search."] = "Выберите группы, которые вы хотели бы включить в поиск."
...
L["Shift-Left-Click to export this search."] = "Shift-Left-Click что бы скопировать"
L["Shift-Right-Click to remove this recent search."] = "Shift-Right-Click дял удаления"
...
L["When in destroy mode, you simply enter a target item (ink/pigment, enchanting mat, gem, etc) into the search box to search for everything you can destroy to get that item."] = "Когда вы находитесь в режиме разрушения, вы просто вводите целевой предмет (чернила/пигмент, материал для зачарования, драгоценный камень и т. д.) в поле поиска, чтобы найти все, что вы можете разрушить, чтобы получить этот предмет."
L["When in normal mode, you may run simple and filtered searches of the auction house."] = "Когда вы находитесь в обычном режиме, вы можете запустить простой и отфильтрованный поиск аукционного дома."
