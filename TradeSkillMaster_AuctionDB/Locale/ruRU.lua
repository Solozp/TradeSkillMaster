...
L["A GetAll scan is the fastest in-game method for scanning every item on the auction house. However, there are many possible bugs on Blizzard's end with it including the chance for it to disconnect you from the game. Also, it has a 15 minute cooldown."] = "Быстрое сканирование - самый быстрый внутриигровой способ сканирования. Однако, из-за из-за ошибок со стороны Blizzard's, существует вероятность отключения от сервера. Кроме того, он имеет 15-минутный перерыв."
L["A full auction house scan will scan every item on the auction house but is far slower than a GetAll scan. Expect this scan to take several minutes or longer."] = "Полный скан Аукциона просканирует каждый товар, но намного дольше, чем Быстрое сканирование. Ждите, это займёт несколько минут или более."				 
...
L["Can't run a GetAll scan right now."] = "Сейчас невозможно запустить Быстрое сканирование."
...
L["GetAll scan did not run successfully due to issues on Blizzard's end. Using the TSM application for your scans is recommended."] = "Быстрое сканирование завершилось неудачно из-за проблем со стороны Blizzard. Рекомендуется использовать для сканирования TSM."
...
L["It is strongly recommended that you reload your ui (type '/reload') after running a GetAll scan. Otherwise, any other scans (Post/Cancel/Search/etc) will be much slower than normal."] = "Настоятельно рекомендуем перезагрузить ваш интерфейс (наберите в чате '/reload') после выполнения Быстрого сканирования. Иначе, любые другие сканы (Выставить/Отменить/Поиск/т.д.) будут намного медленнее, чем обычно."
...
L["Ready"] = "Доступно"
L["Ready in %s min and %s sec"] = "Доступно через %s мин %s сек"
...
L["Run GetAll Scan"] = "Быстрое сканирование"
L["Running query..."] = "Осуществляется запрос..."
L["%s ago"] = "%s назад"
L["Scan Selected Groups"] = "Скан выбранных групп"
...
L["This will do a slow auction house scan of every item in the selected groups and update their AuctionDB prices. This may take several minutes."] = "Это позволит сделать медленное сканирование аукционна каждого элемента в выбранных группах и обновить их цены AuctionDB. Это может занять несколько минут."
