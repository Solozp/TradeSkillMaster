...
L["Buy items from the AH"] = "Купить предметы на аукционе"
L["Buy materials for my TSM_Crafting queue"] = "Купить материалы для моей очереди TSM_Crafting"
...
L["|cffffff00Important Note:|r You do not currently have any modules installed / enabled for TradeSkillMaster! |cff77ccffYou must download modules for TradeSkillMaster to have some useful functionality!|r Please visit http://www.curse.com/addons/wow/tradeskill-master and check the project description for links to download modules."] = "|cffffff00Important Внимание:|r У Вас нет установленных/включенных модулей TSM! |cff77ccff Вы должны скачать/включить их, для возможности использовать весь функционал TSM.r Посетите http://www.curse.com/addons/wow/tradeskill-master для более подробной информации"
...
L["Dust"] = "Пыль"
L["Embed TSM Tooltips"] = "Встроить TSM подсказку"
...
L["None of your groups have %s operations assigned. Type '/tsm' and click on the 'TradeSkillMaster Groups' button to assign operations to your TSM groups."] = "Ни одна из групп не имеет назначенных операций %s. Набериет  '/tsm' и щелкните  кнопку 'Группы' для назначения Операций Группам."
L["<No Operation>"] = "<Нет Операции>"
L["<No Operation Selected>"] = "<Не выбрана операция>" -- Needs review
...
L["Paste the list of items into the box below and hit enter or click on the 'Okay' button. You can also paste an itemLink into the box below to add a specific item to this group."] = "Вставить список Предметов в поле ввода ниже и нажмите ввод или нажмите на 'OK'. Вы также можете вставить ссылку Предмета, чтобы добавить его к этой Группе."
...
-- L["Select the group you'd like to use. Once you have done this, click on the button below. Currently Selected Group: %s"] = "Выберите группу, которую вы хотите использовать. Как только вы это сделаете, нажмите на кнопку ниже. Текущая выбранная группа: %s""
...
L["Version:"] = "Версия:"
L["View current auctions and choose what price to post at"] = "Просмотрите текущие аукционы и выберите, какую цену разместить на них"
...
L["Waiting for Scan to Finish"] = "Ожидание завершения сканирования"
